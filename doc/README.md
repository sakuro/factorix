# Factorix Documentation

This directory contains technical documentation for the Factorix project.
...
- [application.md](components/application.md) - DI container and configuration
