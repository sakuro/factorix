...
Factorix.configure do |config|
  ...
  # config.cache.download.file_system.root = Pathname("#{Dir.home}/.cache/factorix/download")
  ...
  # config.cache.api.file_system.root = Pathname("#{Dir.home}/.cache/factorix/api")
  ...
  # config.cache.info_json.file_system.root = Pathname("#{Dir.home}/.cache/factorix/info_json")
