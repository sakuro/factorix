...
RSpec.describe Factorix::Types::Tag do
  describe ".for" do
    context "with known tag values" do
      ...
      it "returns predefined instance for logistics" do
        tag = Factorix::Types::Tag.for("logistics")
      ...
      it "returns predefined instance for circuit-network" do
        tag = Factorix::Types::Tag.for("circuit-network")
    ...
    context "with flyweight pattern" do
      it "returns same instance for same tag value" do
        tag1 = Factorix::Types::Tag.for("transportation")
        tag2 = Factorix::Types::Tag.for("transportation")
        expect(tag1).to be(tag2)
      end

      it "returns same instance for logistics" do
        tag1 = Factorix::Types::Tag.for("logistics")
        tag2 = Factorix::Types::Tag.for("logistics")
        expect(tag1).to be(tag2)
      end
    end
    ...
    context "with unknown tag value" do
      it "raises KeyError" do
        expect {
          Factorix::Types::Tag.for("unknown-tag")
  ...
  describe "private constructors" do
    it "does not allow direct instantiation via new" do
      expect {
        Factorix::Types::Tag.new(value: "test", name: "Test", description: "Test")
      }.to raise_error(NoMethodError, /private method/)
    end

    it "does not allow direct instantiation via []" do
      expect {
        Factorix::Types::Tag[value: "test", name: "Test", description: "Test"]
      }.to raise_error(NoMethodError, /private method/)
    end
  end
end
