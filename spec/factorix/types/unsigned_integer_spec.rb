...
RSpec.describe Factorix::Types::UnsignedInteger do
  describe "#initialize" do
    it "accepts positive integers" do
      expect { Factorix::Types::UnsignedInteger.new(42) }.not_to raise_error
    end

    it "accepts zero" do
      expect { Factorix::Types::UnsignedInteger.new(0) }.not_to raise_error
    end

    it "raises ArgumentError for negative integers" do
      expect { Factorix::Types::UnsignedInteger.new(-5) }.to raise_error(ArgumentError, "value must be non-negative")
    end

    it "raises ArgumentError for non-Integer values" do
      expect { Factorix::Types::UnsignedInteger.new(3.14) }.to raise_error(ArgumentError, "value must be an Integer")
    end
  end
  ...
  describe "arithmetic operations" do
    it "behaves like an Integer" do
      unsigned_int = Factorix::Types::UnsignedInteger.new(10)
  ...
  describe "#==" do
    it "compares with another UnsignedInteger by value" do
      a = Factorix::Types::UnsignedInteger.new(42)
      b = Factorix::Types::UnsignedInteger.new(42)
      c = Factorix::Types::UnsignedInteger.new(10)
  ...
  describe "#inspect" do
    it "returns a meaningful string representation" do
      unsigned_int = Factorix::Types::UnsignedInteger.new(42)
      expect(unsigned_int.inspect).to match(/Factorix::Types::UnsignedInteger.*value=42/)
    end
  end
end
