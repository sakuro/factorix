...
RSpec.describe Factorix::Types::Category do
  describe ".for" do
    context "with known category values" do
      ...
      it "returns predefined instance for utilities" do
        category = Factorix::Types::Category.for("utilities")
    ...
    context "with flyweight pattern" do
      it "returns same instance for same category value" do
        category1 = Factorix::Types::Category.for("content")
        category2 = Factorix::Types::Category.for("content")
        expect(category1).to be(category2)
      end

      it "returns same instance for no-category and empty string" do
        category1 = Factorix::Types::Category.for("no-category")
        category2 = Factorix::Types::Category.for("")
        expect(category1).to be(category2)
      end
    end
    ...
    context "with unknown category value" do
      it "raises KeyError" do
        expect {
          Factorix::Types::Category.for("unknown-category")
  ...
  describe "private constructors" do
    it "does not allow direct instantiation via new" do
      expect {
        Factorix::Types::Category.new(value: "test", name: "Test", description: "Test")
      }.to raise_error(NoMethodError, /private method/)
    end

    it "does not allow direct instantiation via []" do
      expect {
        Factorix::Types::Category[value: "test", name: "Test", description: "Test"]
      }.to raise_error(NoMethodError, /private method/)
    end
  end
end
