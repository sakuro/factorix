...
RSpec.describe Factorix::Types::SignedInteger do
  describe "#initialize" do
    it "accepts positive integers" do
      expect { Factorix::Types::SignedInteger.new(42) }.not_to raise_error
    end

    it "accepts negative integers" do
      expect { Factorix::Types::SignedInteger.new(-5) }.not_to raise_error
    end

    it "accepts zero" do
      expect { Factorix::Types::SignedInteger.new(0) }.not_to raise_error
    end

    it "raises ArgumentError for non-Integer values" do
      expect { Factorix::Types::SignedInteger.new(3.14) }.to raise_error(ArgumentError, "value must be an Integer")
    end
  end
  ...
  describe "arithmetic operations" do
    it "behaves like an Integer" do
      signed_int = Factorix::Types::SignedInteger.new(10)
  ...
  describe "#==" do
    it "compares with another SignedInteger by value" do
      a = Factorix::Types::SignedInteger.new(42)
      b = Factorix::Types::SignedInteger.new(42)
      c = Factorix::Types::SignedInteger.new(10)
  ...
  describe "#inspect" do
    it "returns a meaningful string representation" do
      signed_int = Factorix::Types::SignedInteger.new(42)
      expect(signed_int.inspect).to match(/Factorix::Types::SignedInteger.*value=42/)
    end
  end
end
