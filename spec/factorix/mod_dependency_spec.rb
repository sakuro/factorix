...
RSpec.describe Factorix::MODDependency do
  ...
  describe ".new" do
    context "with valid parameters" do
      it "creates a required dependency without version requirement" do
        dep = Factorix::MODDependency[mod: Factorix::MOD[name: "base"], type: :required]
      ...
      it "creates an optional dependency with version requirement" do
        dep = Factorix::MODDependency[mod: Factorix::MOD[name: "some-mod"], type: :optional, version_requirement: requirement]
      ...
      it "creates an incompatible dependency" do
        dep = Factorix::MODDependency[mod: Factorix::MOD[name: "bad-mod"], type: :incompatible]
        expect(dep.type).to eq(:incompatible)
      end

      it "creates a hidden optional dependency" do
        dep = Factorix::MODDependency[mod: Factorix::MOD[name: "hidden-mod"], type: :hidden]
        expect(dep.type).to eq(:hidden)
      end

      it "creates a load-neutral dependency" do
        dep = Factorix::MODDependency[mod: Factorix::MOD[name: "neutral-mod"], type: :load_neutral]
    ...
    context "with invalid type" do
      it "raises ArgumentError" do
        expect {
          Factorix::MODDependency[mod: Factorix::MOD[name: "some-mod"], type: :invalid]
    ...
    context "with invalid version_requirement" do
      it "raises ArgumentError when not a MODVersionRequirement" do
        expect {
          Factorix::MODDependency[mod: Factorix::MOD[name: "some-mod"], type: :required, version_requirement: ">= 1.2.0"]
  ...
  describe "#required?" do
    ...
    it "returns false for optional dependency" do
      dep = Factorix::MODDependency[mod: Factorix::MOD[name: "mod"], type: :optional]
      expect(dep.required?).to be(false)
    end

    it "returns false for incompatible dependency" do
      dep = Factorix::MODDependency[mod: Factorix::MOD[name: "mod"], type: :incompatible]
      expect(dep.required?).to be(false)
    end
  end
  ...
  describe "#optional?" do
    ...
    it "returns true for hidden optional dependency" do
      dep = Factorix::MODDependency[mod: Factorix::MOD[name: "mod"], type: :hidden]
      expect(dep.optional?).to be(true)
    end

    it "returns false for required dependency" do
      dep = Factorix::MODDependency[mod: Factorix::MOD[name: "mod"], type: :required]
  ...
  describe "#load_neutral?" do
    it "returns true for load-neutral dependency" do
      dep = Factorix::MODDependency[mod: Factorix::MOD[name: "mod"], type: :load_neutral]
  ...
  describe "#satisfied_by?" do
    context "without version requirement" do
      let(:dep) { Factorix::MODDependency[mod: Factorix::MOD[name: "base"], type: :required] }
    ...
    context "with version requirement" do
      let(:dep) do
        Factorix::MODDependency[mod: Factorix::MOD[name: "some-mod"], type: :required, version_requirement: requirement]
      end
  ...
  describe "#to_s" do
    ...
    it "returns mod name with requirement for required dependency with version" do
      dep = Factorix::MODDependency[mod: Factorix::MOD[name: "some-mod"], type: :required, version_requirement: requirement]
      expect(dep.to_s).to eq("some-mod >= 1.2.0")
    end

    it "returns '? mod-name' for optional dependency" do
      dep = Factorix::MODDependency[mod: Factorix::MOD[name: "opt-mod"], type: :optional]
    ...
    it "includes version requirement when present" do
      dep = Factorix::MODDependency[mod: Factorix::MOD[name: "opt-mod"], type: :optional, version_requirement: requirement]
