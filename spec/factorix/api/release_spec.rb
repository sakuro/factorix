...
RSpec.describe Factorix::API::Release do
  describe "#initialize" do
    ...
    it "creates Release from hash with keyword arguments" do
      release = Factorix::API::Release[**release_hash]
      ...
      expect(release.version).to be_a(Factorix::MODVersion)
    ...
    it "handles different time formats" do
      ...
      release = Factorix::API::Release[**hash]
