...
RSpec.describe Factorix::Dependency::MODVersionRequirement do
  ...
  describe ".new" do
    context "with valid operator" do
      it "creates a requirement with '>=' operator" do
        requirement = Factorix::Dependency::MODVersionRequirement[operator: ">=", version: version_1_2_0]
    ...
    context "with invalid version" do
      it "raises ArgumentError when version is not a MODVersion" do
        expect {
          Factorix::Dependency::MODVersionRequirement[operator: ">=", version: "1.2.0"]
  ...
  describe "#satisfied_by?" do
    context "with '=' operator" do
      let(:requirement) { Factorix::Dependency::MODVersionRequirement[operator: "=", version: version_1_2_0] }
