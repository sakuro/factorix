...
RSpec.describe Factorix::ServiceCredential do
  describe ".from_env" do
    ...
    it "raises ArgumentError when FACTORIO_USERNAME is not set" do
      ...
      expect { Factorix::ServiceCredential.from_env }.to raise_error(ArgumentError, "username must not be nil")
    end
    ...
    it "raises ArgumentError when FACTORIO_TOKEN is not set" do
      ...
      expect { Factorix::ServiceCredential.from_env }.to raise_error(ArgumentError, "token must not be nil")
    end
    ...
    it "raises ArgumentError when FACTORIO_USERNAME is empty" do
      ...
      expect { Factorix::ServiceCredential.from_env }.to raise_error(ArgumentError, "username must not be empty")
    end
    ...
    it "raises ArgumentError when FACTORIO_TOKEN is empty" do
      ...
      expect { Factorix::ServiceCredential.from_env }.to raise_error(ArgumentError, "token must not be empty")
    end
  end
  ...
  describe ".from_player_data" do
    ...
    it "raises ArgumentError when service-username is missing" do
      ...
      expect { Factorix::ServiceCredential.from_player_data }.to raise_error(ArgumentError, "username must not be nil")
    end
    ...
    it "raises ArgumentError when service-token is missing" do
      ...
      expect { Factorix::ServiceCredential.from_player_data }.to raise_error(ArgumentError, "token must not be nil")
    end
